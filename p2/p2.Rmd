...
knitr::kable(list(a27,a28,a29), digits=0, caption = "Confusion Table for different optimization window sizes", format = "latex" ,booktabs=TRUE)%>% kableExtra::kable_styling(latex_options = c("hold"), "striped", full_width = F) %>% group_rows("Window of Optimization 200 and Window of Validation 30",1,5) %>% group_rows("Window of Optimization 120 and Window of Validation 30", 6, 10) %>%  group_rows("Window of Optimization 80 and Window of Validation 30", 11,14)
```
