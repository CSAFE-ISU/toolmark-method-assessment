...
*By failed test, what is being meant is that the method fails to conduct a statistical test because of incorrect identification of Maximum correlations windows required for comparison of the two striation marks. This means that there is no resolution as to the two striations being a match or a non-match. Which makes it impossible to classify it as either Type 1 (False Positive) or Type 2 (False Negative) rate.*
