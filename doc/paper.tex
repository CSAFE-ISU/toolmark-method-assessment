...
calculation. In this paper, we are investigating the applicability of
the Chumbley scoring method by \citet{hadler} to assess striation marks
on bullet lands for same-source identification. The Chumbley score
provides us with another approach in the same-source assessment of
bullet striation marks.
\end{abstract}
...
{\textcolor{orange}{What are we investigating in this paper, and what is the structure for the paper?}}
