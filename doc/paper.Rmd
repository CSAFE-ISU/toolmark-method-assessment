...
Since we are only interested in a non-parameteric U statistic, \citet{hadler} proposed a normalization procedure in the Validation step that goes to some extent to address the issue of mutual dependence. Also the same shift and different shift substep was modified by \citet{hadler} to use a deterministic rule for sampling same-shift and different shift-samples as opposed to the originally proposed random samples.
