...
## Motivation
Same source analyses are a major part of an Forensic Toolmark examiners job. In current practice firearm examiners  make these comparisons visually under a comparison microscope and make one of the following four conclusions: identification, inconclusive, elimination or unsuitable for examination \citet{afte-website-2}. These conclusions are made on the basis of "unique surface contours" of the two toolmarks being in "sufficient agreement" \citep{afte-toolmarks1998}. AFTE describes the term "sufficient agreement" as the possibility of another tool producing the markings under comparison, as practically impossible \citep{afte-toolmarks1998} \citep{afte-website}. \gk{Although, they go on to concede that the interpretation of the identification depends on the examiner and is  therefore subjective in nature.} 

One of the main criticisms in the toolmark examination first raised by the National Research Council in 2009 \citep{NAS:2009} and later emphasized further by the President's Council of Advisors on Science and Technology \citep{pcast2016} are the amount of subjectivity in the assessment and the lack of error rates.
Using a statistical approach removes both subjectivity from the assessment and allows us to provide error rates for both false positive and false negative identifications.

Digitized images, e.g. profilometers or confocal microscopy allow us to measure the surface \citep{vorburger2016} and can be used to conduct statistical analysis on the markings. Multiple toolmarks have been studied in the literature:  \citet{manytoolmarks1, chumbley} have studied screwdriver marks digitized using a profilometer,  \citet{manytoolmarks2} have investigated screwdriver, tongue and groove pliers marks that are generated using a confocal microscope,  while slip-joint pliers have been investigated by \citet{afte-chumbley} using digitized marks generated by a surface profilemeter. \citet{manytoolmarks1} used an algorithm which compares many small windows in the markings between two toolmarks and the maximum pearson correlation coefficient as the statistical index for concluding matches and non-matches. The Chumbley scoring method, first introduced by \citet{chumbley} uses a similar but much more extenstive framework which includes a non-parametric statistical test. This was later improved by Hadler and Morris \citep{hadler}. In this paper, we are investigating the applicability of the Chumbley scoring method by \citet{hadler} to assessing striation marks on bullets for same-source identification.

Striation marks on bullets are made by impurities in the barrel. As the bullet travels through the barrel, these imperfections leave "scratches" on the bullet surface. Typically, only striation marks in the land engraved areas (LEAs) are considered \citet{afte-article1992}. Bullet Lands are depressed areas between bullet grooves made by the rifling action of the barrel. Compared to toolmarks made by screwdrivers striation marks on bullets are typically much smaller, both in length and in width. Bullets also have a curved cross-sectional topography. 

Bullet matching methods depend on the attribute being used for making comparisons. For single feature based matching \citet{chu2013} used an automatic method for counting consequtive matching striae (CMS). They reported zero false positive rate but do not discuss about the false negative rates for land to land matches. \citet{ma2004} and \citet{vorburger2011} discuss about CCF (cross-correlation function) and its discriminating power and application but do not talk about matches and non-matches. \citet{aoas} use multiple attributes like CCF, CMS and compare every land against every other land of the Hamby dataset \citet{hamby}. This also includes matching of all the unknown bullet lands against the known bullet lands. They report for 10,731 comparisons, 18 false negatives and 9 false negatives.

The Chumbley score  provides us with another approach in the same-source assessment of bullet striation marks.
\citet{chumbley}, in their paper, compare two toolmarks with the intention of determining if it comes from the same tool. The data for their study was obtained from 50 sequentially manufactured screwdriver tips. For every 100 comparisons \citet{chumbley} reported 2 false negatives and 9 false positives. The improvement proposed by \citet{hadler} on the other hand gave 0 false  negatives and 3 false poisitives.
...
\gk{could not find the pdf for AFTE theory of identification as it relates to toolmarks pdf. I believe it is not available for free. But from the AFTE Journal the abstract was available which mentions the term " sufficient agreement" as quoted above. Currently the website seems like the most reliable way of quoting AFTE, i have checked other sources in both occasions where the website has been quoated above, like an FBI paper available at the FBI website and some non published but available pdf files in the AFTE website that have used these lines and quoted the AFTE journal. But since I cannot verify it in the Journal I have quoated the website.}
