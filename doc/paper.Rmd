...
```{r type2, fig.height = 5, fig.width = 5, out.width='0.7\\textwidth', fig.cap="Side-by-side comparison of type II error rates of methods CS1 and CS2 by size of optimization window $w_o$."}
