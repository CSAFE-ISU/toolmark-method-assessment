...
\citep{chumbley} found that the algorithm gives false-positives in slightly over 2 cases (or 2%) of the time and about 9 false-negatives (or 9%) for every 100 comparisons. \citep{hadler} on the other hand, in the improved version of the algorithm first described by \citep{chumbley} found a false-positives for 0 cases and 3 false-negatives (or 6%) for 50 comparisons of knwon matches.
\begin{figure}
\centering
