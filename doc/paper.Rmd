...
```{r h44, fig.width=7.75, fig.height=5.25, out.width='\\textwidth', fig.cap="AUC and EER for methods CS1 and CS@ based on high resolution scans of Hamby 44. "}
