...
\autoref{fig:type2} gives an overview of the type 2 error rates of methods CS1 and CS2 over a range of different optimization window sizes $w_o$. 

```{r type22, fig.height = 5, fig.width = 5, out.width='0.7\\textwidth', fig.cap="Side-by-side comparison of type II error rates of methods CS1 and CS2 by size of optimization window $w_o$."}
...
errorsCV %>% 
  ggplot(aes(x = wo, y = beta)) + 
  geom_point(aes(colour = factor(alpha))) +
  geom_line(aes(colour = factor(alpha))) +
