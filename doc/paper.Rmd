...
```{r profile-sketch, fig.height = 3, fig.width='\\textwidth'}
...
profile$l25 <- predict(loess(data = profile, value~y, span=.25))
profile$l50 <- predict(loess(data = profile, value~y, span=.5))
profile$l75 <- predict(loess(data = profile, value~y, span=.75))
profile$l100 <- predict(loess(data = profile, value~y, span=2))
  
pw1 <- profile %>%
  ggplot(aes(x = y, y = value-lw25)) + geom_line() +
  theme_bw() +
  ylab(expression(paste("Depth (in ",mu,m,")", sep=""))) + 
  xlab(expression(paste("Relative Location (in ",mu,m,")", sep=""))) + 
  ggtitle("Coarseness 0.25")

pw2 <- profile %>%
  ggplot(aes(x = y, y = value-lw50)) + geom_line() +
  theme_bw() +
  ylab(expression(paste("Depth (in ",mu,m,")", sep=""))) + 
  xlab(expression(paste("Relative Location (in ",mu,m,")", sep=""))) + 
  ggtitle("Coarseness 0.5")

pw3 <- profile %>%
  ggplot(aes(x = y, y = value-lw75)) + geom_line() +
  theme_bw() +
  ylab(expression(paste("Depth (in ",mu,m,")", sep=""))) + 
  xlab(expression(paste("Relative Location (in ",mu,m,")", sep=""))) + 
  ggtitle("Coarseness 0.75")

pw4 <- profile %>%
  ggplot(aes(x = y, y = value-lw100)) + geom_line() +
  theme_bw() +
  ylab(expression(paste("Depth (in ",mu,m,")", sep=""))) + 
  xlab(expression(paste("Relative Location (in ",mu,m,")", sep=""))) + 
  ggtitle("Coarseness 1")


p1 <- profile %>%
  ggplot(aes(x = y, y = value-l25)) + geom_line() +
  theme_bw() +
  ylab(expression(paste("Depth (in ",mu,m,")", sep=""))) + 
  xlab(expression(paste("Relative Location (in ",mu,m,")", sep=""))) + 
  ggtitle("Coarseness 0.25")
...
p2 <- profile %>%
  ggplot(aes(x = y, y = value-l50)) + geom_line() +
  theme_bw() +
  ylab(expression(paste("Depth (in ",mu,m,")", sep=""))) + 
  xlab(expression(paste("Relative Location (in ",mu,m,")", sep=""))) + 
  ggtitle("Coarseness 0.5")
...
p3 <- profile %>%
  ggplot(aes(x = y, y = value-l75)) + geom_line() +
  theme_bw() +
  ylab(expression(paste("Depth (in ",mu,m,")", sep=""))) + 
  xlab(expression(paste("Relative Location (in ",mu,m,")", sep=""))) + 
  ggtitle("Coarseness 0.75")
...
p4 <- profile %>%
  ggplot(aes(x = y, y = value-l100)) + geom_line() +
  theme_bw() +
  ylab(expression(paste("Depth (in ",mu,m,")", sep=""))) + 
  xlab(expression(paste("Relative Location (in ",mu,m,")", sep=""))) + 
  ggtitle("Coarseness 1")

prof  <- profile %>% ggplot(aes (x = y, y = value)) + geom_line() +
  theme_bw() +
  ylab(expression(paste("Depth (in ",mu,m,")", sep=""))) + 
  xlab(expression(paste("Relative Location (in ",mu,m,")", sep=""))) + 
  ggtitle("Profile")
grid.arrange(pw1, pw2, pw3, pw4, p1, p2, p3, p4, prof, ncol=4)
```
