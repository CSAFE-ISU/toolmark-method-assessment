...
We would again like to thank the reviewers for their in-depth reviews and the suggestions regarding the manuscript. Please find our detailed response addressing each of the points below.
...
*Thank you for the comment. We have changed the sentence to: This data forms the basis of a statistical analysis that allow us to quantify similarity of markings and serves as a basis for error rate calculations*
...
*Thank you for poining this out. We now have changed all reported numbers regarding errors to percentages, including all figures.*
...
*Thank you for the comment. We have softened the sentence at the end of the paragraph. We also did not mean to make this sentence an absolute statement but were rather speculating ourselves. We have made the change to the manuscript to reflect that better.*
