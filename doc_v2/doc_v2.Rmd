...
```{r wo120, fig.width = 8, fig.height=4.5, fig.cap="The figure on the left shows the actual Type I error while the figure on the right shows the Type II error for different validation window sizes and different chosen nominal alpha levels when the size of the optimization window = 120"}
...
```{r wo120-profile, fig.width = 8, fig.height=4.5, fig.cap="The figure on the left shows the actual Type I error while the figure on the right shows the Type II error for different validation window sizes and different chosen nominal alpha levels when the size of the optimization window = 120"}
...
wo120_1<- wo120 %>% gather(type, error, actual:beta) %>%  
  ggplot(aes(x = wv, y = error, colour = factor(alpha)))+
